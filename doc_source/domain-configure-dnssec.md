...
**Important**  
Route 53 supports DNSSEC signing and DNSSEC for domain registration\. To learn more, see [Configuring DNSSEC signing in Amazon Route 53](dns-configuring-dnssec.md)\.
...
+ [New console](#dnssec-add-keys-new-console)
+ [Old console](#dnssec-add-keys-old-console)

------
#### [ New console ]<a name="domain-configure-dnssec-adding-keys-procedure"></a>
...
1. In the **DNSSEC keys** tab, choose **Add key**\.
...
------
#### [ Old console ]<a name="domain-configure-dnssec-adding-keys-procedure-old"></a>
...
Choose the tab for the console that you are using\.
+ [New console](#dnssec-delete-keys-new-console)
+ [Old console](#dnssec-delete-keys-old-console)

------
#### [ New console ]<a name="domain-configure-dnssec-deleting-keys-procedure"></a>
...
1. In the **DNSSEC keys** tab, choose the radio button next to the key you want to delete, and then choose **Delete key**\.

1. In the **Delete DNSSEC key** dialog box, enter *delete* in the text box to confirm you want to delete the key, and then choose **Delete**\.
**Note**  
...
------
#### [ Old console ]<a name="domain-configure-dnssec-deleting-keys-procedure-old"></a>
