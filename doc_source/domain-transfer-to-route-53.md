...
+ [New console](#domain-transfer-to-route-53-new)
+ [Old console](#domain-transfer-to-route-53-old)
...
1. On the **Contact information** page, enter contact information for the domain registrant, admin, and technical contacts\. The values that you enter here are applied to all of the domains that you're registering\. For more information, see [Values that you specify when you register or transfer a domain](domain-register-values-specify.md)\.
...
+ [To transfer domain registration of up to five domains to Route 53](#domain-transfer-to-route-53-up-to-five-procedure-old)
