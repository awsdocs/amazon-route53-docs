...
+ For registering a new domain, see [register a new domain](#register_new_console)\.
...
## To register a new domain using Route 53<a name="domain-register-procedure-section"></a>
...
+ [New console](#register_new_console)
+ [Old console](#register_old_console)

------
#### [ New console ]<a name="domain-register-procedure_new"></a>
...
1. On the **Contact information** page, enter contact information for the domain registrant, admin, and tech contacts\. The values that you enter here are applied to all of the domains that you're registering\. For more information, see [Values that you specify when you register or transfer a domain](domain-register-values-specify.md)\.
...
------
#### [ Old console ]<a name="domain-register-procedure"></a>
