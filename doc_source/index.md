...
+ [Getting started with Amazon Route 53](getting-started.md)
   + [Use your domain for a static website in an Amazon S3 bucket](getting-started-s3.md)
...
+ [Registering and managing domains using Amazon Route 53](registrar.md)
   ...
   + [Working with records](rrsets-working-with.md)
      + [Choosing a routing policy](routing-policy.md)
         ...
         + [Geolocation routing](routing-policy-geo.md)
            + [Geolocation routing in private hosted zones](routing-policy-geo-phz.md)
         + [Geoproximity routing (traffic flow only)](routing-policy-geoproximity.md)
         + [Latency-based routing](routing-policy-latency.md)
            + [Latency-based routing in private hosted zones](routing-policy-latency-phz.md)
...
+ [What is Amazon Route 53 Resolver?](resolver.md)
...
+ [Security in Amazon Route 53](security.md)
   + [Data protection in Route 53](data-protection.md)
      + [Protection from dangling delegation records in Route 53](protection-from-dangling-dns.md)
