...
+ [Configuring Amazon Route 53 as Your DNS Service](dns-configuring.md)
   + [Migrating DNS Service for an Existing Domain to Amazon Route 53](MigratingDNS.md)
      + [Migrating DNS Service for a Domain that's in Use](migrate-dns-domain-in-use.md)
      + [Migrating DNS Service for an Inactive Domain](migrate-dns-domain-inactive.md)
